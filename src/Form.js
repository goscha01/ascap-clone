...
const options = [
    { value: "individ", label: "Individual / Sole proprietor or Single-member LLC" },
...
const Form = (props) => {
    ...
    const handleSubmit = (e) => {
        if(props.selected !== null) {
            setIsInvalid(false)
            window.location.href="https://ome.ascap.com/"
        } else {
            setIsInvalid(true)
        }
        console.log(selectedValue)
  ...
  return (
    <form onSubmit={handleSubmit}>
         <p>*If you are under 18 years of age please<span> <a href="#">read more about how to join ASCAP.</a></span></p>
    ...
    {(isInvalid && props.selected === null) && <p style={{color:"red"}}>Please select your membership type.</p>}
      <p>
